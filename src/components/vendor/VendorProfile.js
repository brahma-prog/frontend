...
const VendorProfile = ({
  ...
  // Check if legal and address details are filled
              ...
              <div style={styles.profileInfoGrid}>
                <div style={styles.profileInfoItem}>
                  ...
                  <span style={{
                    ...
                    ...(!userProfile?.fullName?.trim() && styles.emptyFieldStyle)
                  }}>
                    {userProfile?.fullName?.trim() 
                ...
                <div style={styles.profileInfoItem}>
                  ...
                  <span style={{
                    ...styles.profileInfoValue,
                    ...(!userProfile?.email?.trim() && styles.emptyFieldStyle)
                  }}>
                    {userProfile?.email?.trim() 
                      ? userProfile.email 
                      : 'Not provided'
                ...
                <div style={styles.profileInfoItem}>
                  ...
                  <span style={{
                    ...styles.profileInfoValue,
                    ...(!userProfile?.phone?.trim() && styles.emptyFieldStyle)
                  }}>
                    {userProfile?.phone?.trim() 
                      ? userProfile.phone 
                      : 'Not provided'
                ...
                <div style={styles.profileInfoItem}>
                  ...
                  <span style={{
                    ...styles.profileInfoValue,
                    ...((!userProfile?.openingTime?.trim() || !userProfile?.closingTime?.trim()) && styles.emptyFieldStyle)
                  }}>
                    {userProfile?.openingTime?.trim() && userProfile?.closingTime?.trim()
