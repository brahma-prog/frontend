      ...
      <section style={styles.searchSection}>
        <div style={styles.searchContainer}>
          ...
          <div style={styles.healthMessage}>
            🛡️ 100% Authentic Products | 🚚 Free Delivery Above ₹499 | 💊 Certified Pharmacy
          </div>
        </div>
                ...
                <div style={styles.productImageContainer}>
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23F7D9EB"/><text x="50" y="50" font-family="Arial" font-size="14" fill="%237C2A62" text-anchor="middle" dy=".3em">Image</text></svg>';
                    }}
                  />
                </div>
