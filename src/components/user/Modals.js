  ...
  const FilePreview = ({ file, preview, type = 'prescription' }) => {
    ...
    return (
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontSize: '3rem', marginBottom: '1rem', color: '#7C2A62' }}>
          {type === 'prescription' ? '📎' : '👤'}
        </div>
      ...
      <div style={styles.modalOverlay}>
        <div style={{...styles.modalContainer('600px'), maxHeight: '80vh', overflowY: 'auto'}} 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', 
                       marginBottom: '1.5rem', borderBottom: '2px solid #F7D9EB', paddingBottom: '1rem' }}>
          ...
          <div style={styles.requirementsBox}>
            <h4 style={{ color: '#7C2A62', margin: '0 0 0.5rem 0', fontSize: '1rem' }}>
    ...
    return (
      <div style={styles.modalOverlay}>
        <div style={styles.modalContainer()} ref={checkoutModalRef}>
          ...
          <p style={{ color: '#666', marginBottom: '1.5rem', textAlign: 'center', lineHeight: '1.5' }}>
    ...
    const DetailItem = ({ label, value, isStatus = false }) => {
      return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
          <span style={{ color: '#666', fontSize: '0.9rem', fontWeight: '500' }}>{label}:</span>
          {isStatus ? (
            <span style={{
              padding: '0.5rem 1rem',
              borderRadius: '20px',
